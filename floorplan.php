<!DOCTYPE html><html lang="en-us"><head>
    ...
    <title>Verona at Damac Hills 2 Floor Plan - Download PDF | Damac Properties</title>
    <meta name="keywords" content="Verona at Damac Hills 2 floor plan brochure, Verona at Damac Hills 2 floor plan pdf, Verona at Damac Hills 2 by Damac Properties floor plan pdf, Verona at Damac Hills 2 download pdf, Verona at Damac Hills 2 by Damac Propertiesfloor plan brochure, Damac Properties Verona at Damac Hills 2 floor plan brochure">
    <meta name="description" content="Download Floor Plan Brochure - Verona at Damac Hills 2 | Damac Properties | Damac Hills 2 | 4 Bedroom Townhouse | Starting Price - AED 1,829,000 | Payment Plan - 70/30, (1% monthly)">
    <meta id="tgMetaURL" property="og:url" content="https://www.tanamiproperties.com/Projects/Verona-at-Damac-Hills-2-Download-FloorPlan">
    <meta id="tgMetaTYPE" property="og:type" content="https://www.tanamiproperties.com/">
    <meta id="tgMetaTITLE" property="og:title" content="Verona at Damac Hills 2 Floor Plan - Download PDF | Damac Properties">
    <meta id="tgMetaDESC" property="og:description" content="Download Floor Plan Brochure - Verona at Damac Hills 2 | Damac Properties | Damac Hills 2 | 4 Bedroom Townhouse | Starting Price - AED 1,829,000 | Payment Plan - 70/30, (1% monthly)">
    <meta name="google-site-verification" content="nfC8N9PpK33rnbR2NIHpQ22ijoL2uxkd0taoAq1TDPc">
    <meta name="yandex-verification" content="c0b8e0f46fd748fe">
    <link rel="canonical" href="https://www.tanamiproperties.com/Projects/Verona-at-Damac-Hills-2-Download-FloorPlan">
    <link rel="shortcut icon" href="favicon.ico">
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700&amp;display=swap" rel="stylesheet">
    <link href="css/Projcss.css" rel="stylesheet">

    <link href="css/Project.css" rel="stylesheet">
    <script src="js/TPTopJS.js"></script>
...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="/Projects/Verona-at-Damac-Hills-2">Overview</a>
        <a href="/Projects/Verona-at-Damac-Hills-2-Amenities">Amenities</a>
        <a href="/Projects/Verona-at-Damac-Hills-2-PaymentPlan">Payment Plan</a>
        <a href="/Projects/Verona-at-Damac-Hills-2-FloorPlans">Floor Plans</a>
        <a href="/Projects/Verona-at-Damac-Hills-2-Location">Location</a>
        <a href="/Projects/Verona-at-Damac-Hills-2-MasterPlan">Master Plan</a>
        <a href="/Projects/Verona-at-Damac-Hills-2#gly">Gallery</a>
        <p>Get in Touch</p>
        <span><a href="tel:+971 4 248 3400" class="border-0">
            <img src="images/call.svg" width="15" height="15" alt="Call Us">
            +971 4 248 3400</a></span>

        <span><a rel="nofollow" href="https://api.whatsapp.com/send?l=en&amp;phone=971551623236&amp;text=I want more information on Verona at Damac Hills 2" target="_blank" class="border-0">
            <img src="images/whats-app.svg" width="15" height="15" alt="WhatsApp">
            +971 55 162 3236</a></span>
    </div>
                            ...
                            <div class="card location rounded-0">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mybrochure">
                                        <a href="/brochure.php" id="QuickBrochure_MainBrochureId" data-key="brochure" onclick="SetBrochureName(this);" class="brochbtn"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Project Brochure</a>
                                        <a href="/floorplan.php" id="QuickBrochure_fpBrochureId" onclick="SetBrochureName(this);" data-key="fpbrochure" class="brochbtn active"><i class="fa fa-object-group" aria-hidden="true"></i>Floor Plan </a>
                                    ...
                                    <div id="QuickBrochure_fpfilterId" class="form-group d-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="userEmail" type="email" placeholder="Email Id *" class="form-control" name="userEmail">
                                    </div>
                                    ...
                                    <div class="row no-gutters m-0">
                                        <div class="col-5 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" aria-label="Country Code" name="userCode" id="userCode">
                                        ...
                                        <input type="submit" name="send" value="DOWNLOAD NOW" class="btn btn-dark d-block">
                                                 <?php if (! empty($message)) {?>
                                                    <div class='success'>
                                                        ...
                                                        <a href="/images/Verona_at_Damac_Hills_2_FloorPlan.pdf">Download PDF</a>
                                                    </div>
                                                <?php } ?>
